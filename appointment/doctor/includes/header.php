...
<nav id="app-navbar" class="navbar navbar-inverse navbar-fixed-top primary">
  ...
  <div class="navbar-header">
    ...
    <a href="dashboard.php" class="navbar-brand">
      ...
      <span class="brand-name">KRC YAZILIM</span>
    </a>
  </div><!-- .navbar-header -->
  ...
  ?>
            ...
            <a href="view-appointment-detail.php?editid=<?php echo $row->ID;?>&&aptid=<?php echo $row->AppointmentNumber;?>" class="media-group-item">
              <div class="media">
                ...
                <div class="media-body">
                  <h5 class="media-heading">Yeni Randevu</h5>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu animated flipInY">
            <li><a href="profile.php"><i class="zmdi m-r-md zmdi-hc-lg zmdi-account-box"></i>Profil</a></li>
            <li><a href="change-password.php"><i class="zmdi m-r-md zmdi-hc-lg zmdi-balance-wallet"></i>Parola Değiştir</a></li>
            <li><a href="logout.php"><i class="zmdi m-r-md zmdi-hc-lg zmdi-sign-in"></i>Çıkış</a></li>
