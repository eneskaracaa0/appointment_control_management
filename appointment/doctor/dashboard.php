...
<head>
	...
	<title>Onlien Randevu CMS </title>
...
?>
						<div class="pull-left">
							...
							<small class="text-color">Bekleyen Yeni Randevular</small>
						</div>
						<span class="pull-right big-icon watermark"><i class="fa fa-paperclip"></i></span>
					</div>
					<footer class="widget-footer bg-warning">
						<a href="new-appointment.php"><small> Ayrıntılar</small></a>
...
?>
						<div class="pull-left">
							...
							<small class="text-color">Onaylı Randevular</small>
						</div>
						<span class="pull-right big-icon watermark"><i class="fa fa-ban"></i></span>
					</div>
					<footer class="widget-footer bg-success">
						<a href="approved-appointment.php"><small> Ayrıntılar</small></a>
...
?>
							...
							<small class="text-color">İptal Randevular</small>
						</div>
						<span class="pull-right big-icon watermark"><i class="fa fa-unlock-alt"></i></span>
					</div>
					<footer class="widget-footer bg-danger">
						<a href="cancelled-appointment.php"><small> Ayrıntılar</small></a>
...
?>
							...
							<small class="text-color">Tüm Randevular</small>
						</div>
						<span class="pull-right big-icon watermark"><i class="fa fa-file-text-o"></i></span>
					</div>
					<footer class="widget-footer bg-primary">
						<a href="all-appointment.php"><small> Ayrıntılar</small></a>
