...
<body class="simple-page">
	...
	<h4 class="form-title m-b-xl text-center">Doktor Kayıt Formu</h4>
	<form action="" method="post">
		<div class="form-group">
			<input id="fname" type="text" class="form-control" placeholder="Ad ve Soyad" name="fname" required="true">
		</div>
		...
		<div class="form-group">
			<input id="mobno" type="text" class="form-control" placeholder="Telefon Numarası" name="mobno" maxlength="10" pattern="[0-9]+" required="true">
		</div>
		<div class="form-group">
...
{               ?>
		...
		<div class="form-group">
			<input id="password" type="password" class="form-control" placeholder="Parola" name="password" required="true">
		</div>
...
<div class="simple-page-footer">
	<p>
		<small>Kayıtlı hesabınız varmı?</small>
